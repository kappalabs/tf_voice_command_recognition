...
out_export = export(tf.constant(str(data_dir/'no/01bb6a2a_nohash_0.wav')))
print(out_export)
...
out_imported = imported(waveform[tf.newaxis, :])
print(out_imported)

# Convert the model
# converter = tf.lite.TFLiteConverter.from_keras_model(model)
concrete_func = export.__call__(model).get_concrete_function()
converter = tf.lite.TFLiteConverter.from_concrete_functions([concrete_func], export)
